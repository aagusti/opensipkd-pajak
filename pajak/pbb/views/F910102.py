...
class KetetapanView(PbbView):
            ...
            if url_dict['id'] == 'post':
                ...
                for id in controls['id'].split(","):
                    ...
                    row_pbb = {
                        ...
                        'npwp'           : re.sub('\D',"",row.wp_npwp.upper())[:16],
                        'kecamatan_wp'   : row.wp_kecamatan.upper()[:20],
                        'provinsi_wp'    :  row.wp_provinsi.upper()[:30],
                        ########################################################
    ...
    def view_csv(self):
        ...
        if url_dict['rpt']=='pdf' :
            ...
            rml_row = open_rml_row(path+'/F910102.row.rml')
            ...
            pdf, filename = open_rml_pdf(path+'/F910102.rml', rows=rows, 
